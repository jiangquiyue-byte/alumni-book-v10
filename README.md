...
本项目由 **无间雨** 重新开启并开源。欢迎大家下载、使用及进行二次开发。您也可以直接下载原始 [ZIP 压缩包](assets/images/alumni_book_v10_5_source.zip)。
...
**二次修改要求：**
如果您对本项目代码进行二次修改或分发，**必须在显著位置添加原作者（无间雨）相关信息并介绍这份代码的来源**。

---

## ⚠️ Bug 声明与未来展望

本项目代码或许存在诸多 Bug，我们深知其不足。我们正在努力开发下一个版本，以期带来更稳定、更完善的体验。在此之前，您可以选择：

1.  **等待下一个版本更新**：我们将持续优化和修复已知问题。
2.  **自行修复**：如果您具备开发能力，欢迎您贡献代码，帮助我们改进项目。

**您的支持是我们前进的动力！**

如果您觉得本项目对您有所帮助，并希望支持我们购买一台更好的电脑，以便开发更多优质应用，欢迎您进行小额捐赠。您的每一份心意，无论 1 元还是 10 元，都将是对我们莫大的鼓励！

**微信捐赠二维码：**

![微信支付](assets/images/donate/wechat_pay.png)

衷心感谢大家的支持！我们承诺将持续上传更多优质代码，在未来为大家带来更多惊喜。

---

## 一、项目简介

同学录系统 v10.5 是一套面向校园纪念场景的轻量级网站方案。系统以前台静态页面为展示层，以 PHP 接口与 JSON 文件为数据层，以后台管理界面为内容维护入口，从而在不依赖数据库和大型框架的前提下，实现学生资料管理、页面生成、站点内容维护、贴纸装饰、背景音乐、班级相册、全景展示与粒子效果配置等完整能力。

10.5 版本的重点不是单纯增加功能数量，而是进一步提升 **结构一致性、视觉表现力与后续维护效率**。本版本新增了枫叶、银杏、羽毛、心形、光泡、书页等多种粒子效果，对前后台粒子预设进行了统一注册化整理，并同步优化了模板运行时、全局字体联动与资源版本参数策略，使系统在长期迭代中更稳定、更容易排障。
...
| 文档体系 | README、开发文档与服务器说明重写为 10.5 版本现状 |
...
同学录系统 v10.5 的目标，是在保留“纯手写、轻依赖、可长期保存”的基础上，让系统真正具备持续维护能力。
